...
( $rv, $stdout, $stderr ) = run_script( $script, [ 'supplementary', '-t', 'lane', '-i', '10018_1#1' ] );
...
# time it should work
copy file( qw( t data 34_pf_sup_script prod.conf ) ), $temp_dir
...
ok -f 'sp.csv', 'found other CSV file';
...
like $log_lines[0], qr|bin/pf supplementary -t lane -i 10018_1#1$|, 'log looks sensible';
