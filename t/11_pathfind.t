...
my $test_log = file('t/data/11_pathfind/_pathfind_test.log');
$test_log->remove;

# simple find - get samples for a lane
my %params = (
  environment => 'test',
  config_file => 't/data/11_pathfind/test.conf',
  id          => '10018_1',
  type        => 'lane',
);
...
is_deeply $pf->_ids, [ '10018_1', '10263' ], 'got ID list from file';
is $pf->_type, 'lane', 'got ID type as "lane"';
