...
my $sorter;
lives_ok { $sorter = Bio::Path::Find::Sorter->new(environment => 'test', config_file => 't/data/07_sorter/test.conf') }
  'got a sorter';

my $dbm = Bio::Path::Find::DatabaseManager->new(environment => 'test', config_file => 't/data/07_sorter/test.conf');
